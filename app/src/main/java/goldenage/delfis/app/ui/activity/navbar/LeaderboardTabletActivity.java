...
public class LeaderboardTabletActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaderboard_tablet);
        ...
        Toast.makeText(LeaderboardTabletActivity.this, "Carregando usuários...", Toast.LENGTH_LONG).show();
        loadLeaderboard(user.getToken());

        nav.setOnItemSelectedListener(item -> {
            Intent intent = ActivityUtil.getNextIntent(LeaderboardTabletActivity.this, item);
        ...
        call.enqueue(new Callback<List<User>>() {
            ...
            public void onResponse(Call<List<User>> call, Response<List<User>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(LeaderboardTabletActivity.this, "Falha ao carregar placar. Tente novamente mais tarde.", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<List<User>> call, Throwable t) {
                ...
                Toast.makeText(LeaderboardTabletActivity.this, "Não foi possível carregar o placar. Tente novamente mais tarde.", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(LeaderboardTabletActivity.this, HomeActivity.class);
        intent.putExtra("user", user);
        startActivity(intent);
        finish();
    }
